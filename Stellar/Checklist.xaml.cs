...
namespace Stellar
{
    ...
    public partial class Checklist : Window
    {
        ...
        public List<string> ListExcludedCores = new List<string>();
        ...
        {
            InitializeComponent();
            //CenterWindowOnScreen(); //Call Method

            //webBrowser.Navigate("http://buildbot.libretro.com/nightly/windows/x86_64/");

            //webBrowser.GetElementsByTagName("HTML")[0].OuterHtml;
